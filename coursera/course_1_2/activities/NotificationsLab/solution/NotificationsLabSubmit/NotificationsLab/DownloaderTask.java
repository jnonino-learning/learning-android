...
public class DownloaderTask extends AsyncTask<String, Void, String[]> {
	...
	public static final int txtFeeds[] = {R.raw.tswift, R.raw.rblack,
			R.raw.lgaga};
	protected static final int FLAG_UPDATE_CURRENT = 0;
		...
		mApplicationContext.sendOrderedBroadcast(new Intent(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						// DONE: Check whether the result code is not
						...
						if (getResultCode() == MainActivity.IS_ALIVE) {
							...
							Intent restartMainActivityIntent = new Intent();
							restartMainActivityIntent
									.setFlags(FLAG_UPDATE_CURRENT);
							...
							mContentView.setTextViewText(
									R.layout.custom_notification, successMsg);
							...
							mBuilder.setContentTitle(successMsg);
